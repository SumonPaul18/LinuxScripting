...
wget https://raw.githubusercontent.com/SumonPaul18/linux-shell-hub/refs/heads/main/projects/server-setup/setup-server.sh && chmod +x setup-server.sh && . setup-server.sh
```
